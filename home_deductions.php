  ...
  <div class="container">
    <div class="masthead">
      <h3>
        ...
        <a data-toggle="modal" href="#tywish" class="pull-right"><b>Admin</b></a>
      </h3>
      <nav>
    ...
    <form class="form-horizontal" action="#" name="form">
      ...
      <div class="form-group">
        <label class="col-sm-5 control-label">absent :</label>
        <div class="col-sm-4">
          <?php echo $absent; ?>.00
        </div>
      </div>
          ...
          <div class="modal-body" style="padding:40px 50px;">
            ...
            <form class="form-horizontal" action="add_deductions.php" name="form" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" name="nssf" class="form-control" required="required" value="<?php echo $nssf; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">absent</label>
                <div class="col-sm-8">
                  <input type="text" name="absent" class="form-control" value="<?php echo $absent; ?>" required="required">
                </div>
              </div>
              <div class="form-group">
